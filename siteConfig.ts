...
export const siteConfig = {
  ...
  authorName: "Nefert",
  bio: "游走于前后端工程与本地模型之间的研究者，关注全栈开发、本地模型部署、模型微调，以及编程原理、并发与性能等底层方向，近期在做本地大模型的部署与推理优化（量化、长上下文）、LoRA 微调实验，同时研究编译原理与高并发系统设计。",
...
// 修改这里：变成图片数组
  ...
  cloudMusicIds: ["2744272266", "3387937783", "2065873082", "2065871536", "3397872556", "3406727231", "3371305930", "3412017935", "2158615075", "3399851341", "2124415181", "496869422", "22817150", "2088017234", "506196018", "1321392124", "3355990217", "2644568443", "3408102345", "5204060", "5204057", "1809646618", "3361076230", "1859390262", "3342981041"],
  social: {
  ...
  // 👇 【新增】：全局背景弹幕配置
  danmakuList: ["大模型的幻觉治好了吗？", "Agent 又在改自己的代码了", "GEPA 技能进化中...", "MCP 工具调用链跑通了", "上下文窗口又不够了", "KV Cache 省了一大笔 token", "OmO 编排调度中", "多智能体正在开会", "DeepSeek 还是 GLM？", "AST-Grep 精准定位中", "技能库更新中...", "LSP 诊断全绿", "罗德岛博士今天也很忙", "干员调度指令已下发", "源石技艺波动观测中", "基建无人值守模式 ON", "龙门币+9999", "理智值不足，请休息", "阿米娅在唱荒芜了", "今晚月色真美", "要相信光", "雨停之前请撑伞", "凌晨三点的灵感最甜", "写代码就是在写诗", "Bug 再见了", "编译一次通过！", "Ctrl+S 保平安", "需求又改了亿点点", "摸鱼一时爽，一直摸鱼一直爽", "今天也是元气满满的一天", "咖啡续命中...", "键盘冒烟警告", "服务器永不宕机", "延迟 0ms 达成", "神经网络正在做梦", "数据在流动，世界在旋转", "赛博朋克 2077 般的夜", "AI 在数星星", "宇宙很大，生活更大", "出发吧，去更远的地方"],
  gitalkConfig: {
